...
const ItemDetails = () => {
    ...
    const handleIncrease = (event) => {
        ...
        if (inputQuantity > 0) {
            ...
            toast.info('Quantity must be higher than 0')
        }
    }
                        ...
                        <div className='md:pr-16 my-auto col-span-2 md:col-span-1'>
                            <div className='mx-auto font-[poppins]'>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <div className=' w-[120px] shadow-md mt-3 mb-10'>
                                        <p className='text-center font-bold'> {
                                            inventory.quantity === 0 ? <span className='text-red-600'>Sold Out</span> : <span className='font-bold '>Available</span>
                                        } </p>

    ...
    return (
        <div>
            <div className='banner grid grid-cols-2'>
                <div className='mt-10 md:mt-0 col-span-2 md:col-span-1 text-white banner-title flex flex-col justify-center items-center md:ml-28'>

                    <h1 className='mt-0'>SUPER OFFER</h1>
